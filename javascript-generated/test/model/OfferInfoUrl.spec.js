...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkedeventsClient.OfferInfoUrl();
  });
  ...
  describe('OfferInfoUrl', function() {
    it('should create an instance of OfferInfoUrl', function() {
      // uncomment below and update the code to test OfferInfoUrl
      //var instane = new LinkedeventsClient.OfferInfoUrl();
      //expect(instance).to.be.a(LinkedeventsClient.OfferInfoUrl);
    });
