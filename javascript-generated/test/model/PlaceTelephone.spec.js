...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkedeventsClient.PlaceTelephone();
  });
  ...
  describe('PlaceTelephone', function() {
    it('should create an instance of PlaceTelephone', function() {
      // uncomment below and update the code to test PlaceTelephone
      //var instane = new LinkedeventsClient.PlaceTelephone();
      //expect(instance).to.be.a(LinkedeventsClient.PlaceTelephone);
    });
