...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkedeventsClient.EventName();
  });
  ...
  describe('EventName', function() {
    it('should create an instance of EventName', function() {
      // uncomment below and update the code to test EventName
      //var instane = new LinkedeventsClient.EventName();
      //expect(instance).to.be.a(LinkedeventsClient.EventName);
    });
