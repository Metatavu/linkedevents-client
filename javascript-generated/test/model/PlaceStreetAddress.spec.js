...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkedeventsClient.PlaceStreetAddress();
  });
  ...
  describe('PlaceStreetAddress', function() {
    it('should create an instance of PlaceStreetAddress', function() {
      // uncomment below and update the code to test PlaceStreetAddress
      //var instane = new LinkedeventsClient.PlaceStreetAddress();
      //expect(instance).to.be.a(LinkedeventsClient.PlaceStreetAddress);
    });
