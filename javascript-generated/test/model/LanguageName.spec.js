...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkedeventsClient.LanguageName();
  });
  ...
  describe('LanguageName', function() {
    it('should create an instance of LanguageName', function() {
      // uncomment below and update the code to test LanguageName
      //var instane = new LinkedeventsClient.LanguageName();
      //expect(instance).to.be.a(LinkedeventsClient.LanguageName);
    });
