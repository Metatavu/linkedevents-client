...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkedeventsClient.EventInfoUrl();
  });
  ...
  describe('EventInfoUrl', function() {
    it('should create an instance of EventInfoUrl', function() {
      // uncomment below and update the code to test EventInfoUrl
      //var instane = new LinkedeventsClient.EventInfoUrl();
      //expect(instance).to.be.a(LinkedeventsClient.EventInfoUrl);
    });
