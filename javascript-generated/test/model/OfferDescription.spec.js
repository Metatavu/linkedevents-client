...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkedeventsClient.OfferDescription();
  });
  ...
  describe('OfferDescription', function() {
    it('should create an instance of OfferDescription', function() {
      // uncomment below and update the code to test OfferDescription
      //var instane = new LinkedeventsClient.OfferDescription();
      //expect(instance).to.be.a(LinkedeventsClient.OfferDescription);
    });
