...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkedeventsClient.PlaceDescription();
  });
  ...
  describe('PlaceDescription', function() {
    it('should create an instance of PlaceDescription', function() {
      // uncomment below and update the code to test PlaceDescription
      //var instane = new LinkedeventsClient.PlaceDescription();
      //expect(instance).to.be.a(LinkedeventsClient.PlaceDescription);
    });
