...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkedeventsClient.KeywordName();
  });
  ...
  describe('KeywordName', function() {
    it('should create an instance of KeywordName', function() {
      // uncomment below and update the code to test KeywordName
      //var instane = new LinkedeventsClient.KeywordName();
      //expect(instance).to.be.a(LinkedeventsClient.KeywordName);
    });
