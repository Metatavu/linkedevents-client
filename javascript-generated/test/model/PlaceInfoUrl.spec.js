...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkedeventsClient.PlaceInfoUrl();
  });
  ...
  describe('PlaceInfoUrl', function() {
    it('should create an instance of PlaceInfoUrl', function() {
      // uncomment below and update the code to test PlaceInfoUrl
      //var instane = new LinkedeventsClient.PlaceInfoUrl();
      //expect(instance).to.be.a(LinkedeventsClient.PlaceInfoUrl);
    });
