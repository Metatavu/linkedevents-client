...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkedeventsClient.PlaceName();
  });
  ...
  describe('PlaceName', function() {
    it('should create an instance of PlaceName', function() {
      // uncomment below and update the code to test PlaceName
      //var instane = new LinkedeventsClient.PlaceName();
      //expect(instance).to.be.a(LinkedeventsClient.PlaceName);
    });
