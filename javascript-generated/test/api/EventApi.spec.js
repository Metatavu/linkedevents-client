...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new LinkedeventsClient.EventApi();
  });
  ...
  describe('EventApi', function() {
    describe('eventCreate', function() {
      it('should call eventCreate successfully', function(done) {
        ...
        //instance.eventCreate(function(error) {
    ...
    describe('eventRetrieve', function() {
      it('should call eventRetrieve successfully', function(done) {
        //uncomment below and update the code to test eventRetrieve
        //instance.eventRetrieve(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('eventUpdate', function() {
      it('should call eventUpdate successfully', function(done) {
        //uncomment below and update the code to test eventUpdate
        //instance.eventUpdate(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
