...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.LinkedeventsClient.EventInfoUrl = factory(root.LinkedeventsClient.ApiClient);
  }
  ...
  /**
   * Constructs a new <code>EventInfoUrl</code>.
   * Link (URL) to a page with more information about event
   * @alias module:model/EventInfoUrl
   * @class
   */
  ...
  /**
   * Constructs a <code>EventInfoUrl</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EventInfoUrl} obj Optional instance to populate.
   * @return {module:model/EventInfoUrl} The populated <code>EventInfoUrl</code> instance.
   */
